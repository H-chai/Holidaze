...
export function SearchForm({ setSearchResults, setSearchText }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-blue text-white cursor-pointer rounded-[10px] py-3 w-full font-medium block md:w-1/2 md:mx-auto lg:w-1/4 transition-all duration-300 border-blue hover:bg-white hover:text-blue hover:border  disabled:cursor-not-allowed"
